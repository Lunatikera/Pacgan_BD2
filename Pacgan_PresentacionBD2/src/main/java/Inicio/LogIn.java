...
public class LogIn extends javax.swing.JFrame {
    ...
    public BeneficiarioDTO conseguirBeneficiario() {
        try {
            System.out.println(gestionarBeneficiarios.listaBeneficiarios());
    ...
    private void initComponents() {
        ...
        Agrupador.add(txtContrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 330, 180, 30));
        ...
        radModoAdmin.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                radModoAdminActionPerformed(evt);
            }
        });
    ...
    private void radModoAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radModoAdminActionPerformed

        modoAdmin = !modoAdmin;
    }//GEN-LAST:event_radModoAdminActionPerformed
